...
__global__ void mm_chain_dp_fill_cuda_optimized(int64_t j, int64_t n, int max_dist_x, int max_dist_y, int bw, int max_iter, int n_segs, int is_cdna, mm128_t *a, float avg_qspan, int32_t *f, int32_t *t, int32_t *p, int32_t *v);
